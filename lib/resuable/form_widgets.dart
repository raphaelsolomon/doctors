      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Center(
            child: Text(
              text,
              style: GoogleFonts.poppins(fontSize: 14.0, color: textcolor, fontWeight: FontWeight.normal),
            ),
          ),
        ),
      ),
        ...
        children: [
          Flexible(
            child: TextField(
              ...
              maxLines: 1,
              decoration: InputDecoration(
                  hintText: 'Apply a Coupon Code', contentPadding: const EdgeInsets.only(left: 10.0, right: 10.0, top: 3.0), hintStyle: getCustomFont(size: 14.0, color: Colors.black45), border: OutlineInputBorder(borderSide: BorderSide.none)),
            ),
          ),
          Container(
            padding: const EdgeInsets.symmetric(horizontal: 15.0),
...
dashWidget(context, {icon = FontAwesome5.calendar_day, text = "Total patients", progress = 0.8, result = '1300+', color = BLUECOLOR}) {
  return Container(
