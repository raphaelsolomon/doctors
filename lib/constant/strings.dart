...
List homeItem1 = [
  {'icon': 'assets/category/medical_center.png', 'title': 'Find a Medical Center', 'desc': 'Find hospitals, laboratories, pharmacies and clinics'},
  {'icon': 'assets/category/store.png', 'title': 'Visit the ePharamcy', 'desc': 'Order medications and get it delivered anywhere'},
  {'icon': 'assets/category/checker.png', 'title': 'Symptoms Checker', 'desc': 'Input symptoms and get instant diagnosis advice'},
  {'icon': 'assets/category/ambulance.png', 'title': 'Book an Ambulance', 'desc': 'Find land, sea and air ambulance providers and book for their services.'},
  {'icon': 'assets/category/medical_center.png', 'title': 'Cementeries Center', 'desc': 'Find the best cemetery center at your neighborhood to lay your love one to rest.'}
];

List homeItem2 = [
  {'icon': 'assets/category/my_patients.png', 'title': 'My Patient', 'desc': 'Manage All your patient medical records and billing with just a click.'},
  {'icon': 'assets/category/prescription.png', 'title': 'E-Prescription', 'desc': 'Create, edit and delect prescription for all your patients with just a click.'},
  {'icon': 'assets/category/timing.png', 'title': 'Timing', 'desc': 'Create, Set , edit, delete and block your practice timing at your own convinience'},
  {'icon': 'assets/category/availability.png', 'title': 'Availability', 'desc': 'Let your patient and colleges know your availabilty'},
  {'icon': 'assets/category/appointment.png', 'title': 'Appointments', 'desc': 'See all incoming and past appointments, you can also reschedule and accept or reject appoinments'},
  {'icon': 'assets/category/book_test.png', 'title': 'Book A Test', 'desc': 'Conviniently Book Diagnosis test from any of our Partner Center closer to you.'}
];

List ONBOARDING = [
  {
    'image': 'assets/auth/prescription.png',
  ...
  {'image': 'assets/auth/appointment.png', 'title': 'Book Appointments with Doctors Right from your Phone and System!', 'description': 'Get Access to a wide range of Specialist Doctors around the World have never been this easy.'},
  {
    'image': 'assets/auth/database.png',
  ...
  {'image': 'assets/auth/book.png', 'title': 'Book Diagnostic Test from Experts Diagnostic Centers Globally!', 'description': 'You can have your Diagnostics Done on Schedule with our Wide network of Reliable Facilities and Centers.'},
  {
    'image': 'assets/auth/delivery.png',
...
final SHADOW = [BoxShadow(color: Colors.grey.shade400, spreadRadius: 1.0, blurRadius: 3.0, offset: Offset(0.0, 1.0))];
...
List removeBottom = [2, 3, -2, -3, -5, -9, -10, 10, -12, -13, -14, -15, -16, -17, -18, -19, 6, 5, 7, -23];
List removeBottom1 = [3, -2, -3, -5, -9, -10, 10, -12, -13, -14, -15, -16, -17, -18, -19, 6, 5, 7, -23];
...
List<NavDrawerItem> getNavdraweritem_(BuildContext context) {
  return [
    ...
    NavDrawerItem(title: 'Dashboard', icon: FontAwesome5.dashcube, children: [], isOpen: false, index: 1),
    NavDrawerItem(title: 'Schedule Timing', icon: FontAwesome.clock, children: [], isOpen: false, index: 2),
    NavDrawerItem(title: 'My Plans', icon: Icons.folder, children: [], isOpen: false, index: 3),
    NavDrawerItem(title: 'E-stores', icon: FontAwesome5.store, children: [], isOpen: false, index: 4), //done
    NavDrawerItem(title: 'My Calender', icon: FontAwesome5.calendar, children: [], isOpen: false, index: 5), //done
    NavDrawerItem(title: 'My Reminder', icon: Icons.alarm, children: [], isOpen: false, index: 6), //done
    NavDrawerItem(title: 'My Prescriptions', icon: FontAwesome5.pills, children: [], isOpen: false, index: 7), //done
    NavDrawerItem(title: 'My Appointment', icon: Icons.family_restroom, children: [], isOpen: false, index: 10), //done
    NavDrawerItem(title: 'My Patients', icon: Icons.person, children: [], isOpen: false, index: -20), //done
    // NavDrawerItem(
    //     title: 'My Profile',
    ...
    NavDrawerItem(
        ...
        isOpen: false,
        index: -0),
    NavDrawerItem(title: 'Sign Out', icon: FontAwesome5.sign_out_alt, children: [], isOpen: false, index: 9), //done
  ];
}
