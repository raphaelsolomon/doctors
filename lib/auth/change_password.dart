        ...
        children: [
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  'Change Password',
                  style: GoogleFonts.poppins(fontSize: 16.0, color: Colors.white, fontWeight: FontWeight.w500),
                ),
                Icon(
                  null,
                  color: Colors.black,
          ...
          Expanded(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  Image.asset('assets/imgs/change_pass.png', repeat: ImageRepeat.noRepeat, fit: BoxFit.contain),
                  const SizedBox(
                    height: 20.0,
                  ),
                  // Text(
